<?php
// Set the $res variable to an empty string
$res = "";
// Start a session
...
<body>
    ...
    <header id='header'>
		<!-- svg of logo -->
		 <!-- Add an onclick event to the svg element to navigate to the homepage when clicked -->
		<svg class="icon " viewBox="0 0 515.16 80.36" onclick="home()">
            <path
            ...
            <path
                ...
                fill="#ffd200"></path>
            <path d="M62.22 65.34c5.69-4.16 9.06-10.81 8.56-20.51 0-.55-.09-.58-.14-1.13h-8.42z" fill="#002596"></path>
            <path d="M53.2 69.52a27 27 0 009-4.18V43.7h-9zM17.15 65.34a27 27 0 009 4.18V43.7h-9z" fill="#8b2346"></path>
		...
		<!-- social media logos  -->
        <div class='rightTop'>
            <span class="top-slim-social">
                <span class="top-slim-social__follow-context">Follow FC Barcelona</span>
                <a href="https://twitter.com/fcbarcelona">
                    <svg class="icon icon--twitter" viewBox="0 0 512.002 512.002">
                        <path
                ...
                <a href="https://www.facebook.com/fcbarcelona">
                    <svg class="icon icon--facebook" viewBox="0 0 257.72 257.72">
                        <path
                ...
                <a href="https://www.instagram.com/fcbarcelona/">
                    <svg class="icon icon--instagram" viewBox="0 0 169.063 169.063">
                        <path
                ...
                <a href="https://www.youtube.com/user/fcbarcelona">
                    <svg class="icon icon--youtube" viewBox="0 0 28 20.05">
                        <path
                ...
                <a href="https://www.tiktok.com/@fcbarcelona">
                    <svg class="icon icon--tiktok" viewBox="-32 0 512 512">
                        <path
                ...
                <a href="https://www.twitch.tv/fcbarcelona">
                    <svg class="icon icon--twitch" viewBox="0 0 260 260">
                        <path
			...
			<!-- state of log in or log out -->
            <span><a onclick="login(event)" href="#" class='sign'>
                    <?php echo $res ? 'logout' : 'login' ?>
                </a><span class='sign'>
                    <?php echo $res ?>
                </span> 
			</span>
...
<script>
	...
	// click login or logout to access php logic 
    login = (e) => {
        if (e.target.innerText.includes('out')) {
			// request to php file when user login 
            let xhr = new XMLHttpRequest();
            xhr.open("post", "php_executions/logout.php");
            xhr.send()
            xhr.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
					// when log in successfully to back to home page
                    window.location.href="index.php"
                }
            }
        } else {
			//go back to home page when user logout
            document.getElementsByTagName('iframe')[0].src = 'pages/login.php'
        }
    }
</script>
</html>